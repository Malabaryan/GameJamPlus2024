...
Shader "_Clouds/Clouds Unlit Vertex Color"
{
	...
	SubShader
	{
				...
				struct cloud_appata
		{
			...
			UNITY_VERTEX_INPUT_INSTANCE_ID // Add instancing support
		};

		UNITY_INSTANCING_BUFFER_START(PerInstanceData) // Define instanced properties if needed
		// Add instanced variables if you have any
		...
		float4 tessFunction( cloud_appata v0, cloud_appata v1, cloud_appata v2 )
		{
			return UnityDistanceBasedTess( v0.vertex, v1.vertex, v2.vertex, _TessMin, _TessMax, _TessValue );
		}

		void vertexDataFunc( inout cloud_appata v )
		{
